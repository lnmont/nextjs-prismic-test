...
- Duplicate the <strong>.env</strong> file and rename it to <strong style="color: #023022">.env.local</strong> and inform the API and Token data generated by your dashboard
```bash
PRISMIC_ENDPOINT=
