...
- Duplicate the <strong style="color: blue;">.env</strong> file and rename it to <strong style="color: blue;">.env.local</strong> and inform the API and Token data generated by your dashboard
```bash
PRISMIC_ENDPOINT=
